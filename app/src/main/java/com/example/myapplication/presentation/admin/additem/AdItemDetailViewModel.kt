...
class AdItemDetailViewModel(private val application: MyApplication, private val productRepository: ProductRepository): ViewModel() {
    ...
    fun updateProduct(product: Product) {
        _addStatus.postValue(InternetResult.Loading)
        viewModelScope.launch {
            _addStatus.postValue(productRepository.updateProduct(product))
        }
    }
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = object : ViewModelProvider.Factory {
            ...
            override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T {
                ...
                return AdItemDetailViewModel(application, productRepository) as T
            }
        }
    }
}